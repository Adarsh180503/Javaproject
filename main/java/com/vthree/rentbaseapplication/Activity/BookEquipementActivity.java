...
public class BookEquipementActivity extends AppCompatActivity {
    ...
    Button place_order;
    String todate,fromdate, to_time, from_time = "";
    String booking_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        place_order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (fromdate.isEmpty()) {
                    Toast.makeText(BookEquipementActivity.this, getString(R.string.please_selectdate), Toast.LENGTH_SHORT).show();
                }
                if (todate.isEmpty()) {
                    Toast.makeText(BookEquipementActivity.this, getString(R.string.please_selectdate), Toast.LENGTH_SHORT).show();
                }else if (from_time.isEmpty()) {
                    Toast.makeText(BookEquipementActivity.this, getString(R.string.please_selectfromtime), Toast.LENGTH_SHORT).show();
                } else if (to_time.isEmpty()) {
                    Toast.makeText(BookEquipementActivity.this, getString(R.string.please_selecttotime), Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    databaseReference.child(booking_id).setValue(new BookingModel(booking_id, equipmentModel.getEquipment_id(), equipmentModel.getEquipment_name(),
                            equipmentModel.getDescription(), equipmentModel.getPriseinhr(), equipmentModel.getDeposite(), equipmentModel.getUser_id(), fromdate,todate, from_time,
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    key.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            ///notification code
                                                ...
                                                try {
                                                    notifcationBody.put("title", getString(R.string.equip_booking));
                                                    notifcationBody.put("message", getString(R.string.equip_booking_by) + user_name);
                                    ...
                                    startActivity(intent);
                                    Toast.makeText(BookEquipementActivity.this, getString(R.string.order_sucess), Toast.LENGTH_SHORT).show();
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(BookEquipementActivity.this, getString(R.string.oreder_fail), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
