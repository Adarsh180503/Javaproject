...
public class EquipmentRegisterActivity extends AppCompatActivity {
  ...
  /*  FirebaseStorage storage;
    ...
    void Addequipments()
    {
        ...
        databaseReference.child(equipment_id).setValue(new EquipmentModel(equipment_id,name,user_id,description,imageString,address,city,taluka,prize,deposite,contact,latitude,longitude,dist))
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(EquipmentRegisterActivity.this, getString(R.string.eqip_added_sucess), Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(EquipmentRegisterActivity.this, getString(R.string.eqip_added_fail), Toast.LENGTH_SHORT).show();
            }
        });
    }
