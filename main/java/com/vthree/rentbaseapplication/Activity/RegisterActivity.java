...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText editName,editContact,editAddress,editcity,editTaluka,editTextusertype,editTextPassword;
    ...
    private void registerUser(){
        ...
        if(TextUtils.isEmpty(name)){
            ...
            if (flag == 1) {
                ...
                databaseReference.child(user_id).setValue(new UserModel(user_id,name,address,contact,city,taluka,token,usertype,password))
