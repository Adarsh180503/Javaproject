...
public class BookOrderAdapter extends RecyclerView.Adapter<BookOrderAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.row_book_order_name.setText(context.getString(R.string.equipment)+ bookingModelsl.get(position).getEquipment_name());
        holder.row_booking_date.setText(bookingModelsl.get(position).getBook_from_date() + context.getString(R.string.tooo) + bookingModelsl.get(position).getBook_to_date());
        holder.row_booking_time.setText(bookingModelsl.get(position).getBook_from_time() + context.getString(R.string.tooo) + bookingModelsl.get(position).getBook_to_time());


        if (holder.row_booking_status.getText().equals("Approved")){
            holder.pendding.setVisibility(View.GONE);
            holder.row_booking_status.setText(context.getString(R.string.approve));
            ...
            holder.pendding.setVisibility(View.GONE);
            holder.row_booking_status.setText(context.getString(R.string.diapprove));
        ...
        holder.row_show_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                row_booking_date.setText(model.getBook_from_date() + context.getString(R.string.tooo) + model.getBook_to_date());
                row_booking_time.setText(model.getBook_from_time() + context.getString(R.string.tooo) + model.getBook_to_time());
                                                 ...
                                                 key.addListenerForSingleValueEvent(new ValueEventListener() {
                                                     ...
                                                     public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                         for (DataSnapshot appleSnapshot : dataSnapshot.getChildren()) {
                                                             ...
                                                             try {
                                                                 notifcationBody.put("title", context.getString(R.string.equip_booking));
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Constants.FCM_API, notification,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(context, context.getString(R.string.requesterror), Toast.LENGTH_LONG).show();
