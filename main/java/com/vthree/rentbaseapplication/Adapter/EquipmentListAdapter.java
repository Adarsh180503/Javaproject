...
import com.vthree.rentbaseapplication.Activity.OTPVerificationActivity;
...
public class EquipmentListAdapter extends RecyclerView.Adapter<EquipmentListAdapter.ViewHolder> implements Filterable {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem = layoutInflater.inflate(R.layout.myequip_list_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        try {
            ...
            holder.txt_contact.setText(mFilterLIst.get(position).getTaluka());
